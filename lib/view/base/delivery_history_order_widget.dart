...
class DeliveryHistoryOrderWidget extends StatelessWidget {
  final OrderModel order;
  const DeliveryHistoryOrderWidget({Key? key, required this.order})
      : super(key: key);
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                RichText(
                                  text: TextSpan(
                                    text:
                                        '${getTranslated('Sales Name :', context)!} ',
                                    style: const TextStyle(
                                        fontSize: 12,
                                        color: Colors
                                            .black), // Change color as needed
                                    children: <TextSpan>[
                                      TextSpan(
                                        text: order.sales != null
                                            ? '${order.sales!.fName!} ${order.sales!.lName!}'
                                            : '',
                                      ),
                                    ],
                                  ),
