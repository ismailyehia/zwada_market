...
class _AddressScreenState extends State<AddressScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      : CustomAppBar(context: context, title: getTranslated('address', context))) as PreferredSizeWidget?,
      floatingActionButton: _isLoggedIn && addressList.isEmpty
      ? Padding(
        padding:  EdgeInsets.only(top: ResponsiveHelper.isDesktop(context)
        ?  Dimensions.paddingSizeLarge
        : 0),
        child: !ResponsiveHelper.isDesktop(context)
        ? FloatingActionButton(
          backgroundColor: Theme.of(context).primaryColor,
          onPressed: () =>   _isLoggedIn && addressList.isEmpty ? RouterHelper.getAddAddressRoute('address', 'add', AddressModel()) : null,
          child: const Icon(
