...
class SalesOptionsView extends StatelessWidget {
  final Function? onTap;
  const SalesOptionsView({Key? key, required this.onTap}) : super(key: key);
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        onTap: () => RouterHelper.getSalesMainRoute(
                      ...
                      ListTile(
                        onTap: () =>
                            RouterHelper.getSalesDashboardRoute('history'),
                        leading: Image.asset(Images.order,
                            width: 20,
                            height: 20,
                            color:
