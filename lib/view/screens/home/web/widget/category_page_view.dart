      ...
      itemBuilder: (context, index) {
        ...
        return ListView.builder(
            ...
            itemBuilder: (context, item) {
              ...
              String? name = '';
              categoryProvider
                          .categoryList![currentIndex0]
                          .name![AppLocalization.of(context)!
                              .getCurrentLanguageCode()]
                          .length >
                      15
                  ? name =
                      '${categoryProvider.categoryList![currentIndex0].name![AppLocalization.of(context)!.getCurrentLanguageCode()].substring(0, 15)}...'
              ...
              return OnHover(builder: (isHover) {
                return Container(
                  ...
                  child: InkWell(
                    ...
                    onTap: () => RouterHelper.getCategoryRoute(categoryProvider
                            .categoryList![
                        currentIndex0]), // arguments:  category.categoryList[index].name),
                    child: Column(children: [
                      ClipOval(
                        child: FadeInImage.assetNetwork(
                          placeholder: Images.placeholderImage, width: 125,
