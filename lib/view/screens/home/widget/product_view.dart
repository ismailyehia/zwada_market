  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ProductProvider>(
      builder: (context, prodProvider, child) {
        ...
        else if (productType == ProductType.onSaleProduct) {
          productList = prodProvider.onSaleProductList;
        }
        else if (productType == ProductType.featureProduct) {
          productList = prodProvider.featureProductList;
        }
        if(productList == null ) {
          return productType == ProductType.popularProduct || productType == ProductType.featureProduct ?
          SizedBox(
            height: 250,
        ...
        if (productType == ProductType.popularProduct || productType == ProductType.latestProduct || productType == ProductType.featureProduct) {
          return productType == ProductType.popularProduct || productType == ProductType.featureProduct? SizedBox(
            height: 250,
            child: ListView.builder(
              scrollDirection: Axis.horizontal,
              physics: const BouncingScrollPhysics(),
