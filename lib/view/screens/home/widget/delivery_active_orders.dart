...
import 'package:flutter_restaurant/view/base/delivery_active_order_widget.dart';
...
class DeliveryActiveOrders extends StatelessWidget {
  final ScrollController? scrollController;

  const DeliveryActiveOrders({Key? key, this.scrollController}) : super(key: key);
    ...
    return Consumer<OrderProvider>(
      builder: (context, prodProvider, child) {
        List<OrderModel>? orderList;
          orderList = orderProvider.activeOrderList;
        if(orderList == null ) {
        ...
        if(orderList.isEmpty) {
          ...
          return RefreshIndicator(
            onRefresh: () async {
              await Provider.of<OrderProvider>(context, listen: false).getActiveOrderList(context);
            },
            ...
            GridView.builder(
              ...
              shrinkWrap: true,
              itemBuilder: (BuildContext context, int index) {
                return DeliveryActiveOrderWidget(order: orderList![index]);
              },
            ),
