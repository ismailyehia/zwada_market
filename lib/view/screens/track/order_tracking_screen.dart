...
class OrderTrackingScreen extends StatefulWidget {
  ...
  const OrderTrackingScreen({Key? key, this.orderID, this.phoneNumber})
      : super(key: key);
...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  void initState() {
    ...
    if (widget.orderID != null) {
      orderProvider
          .trackOrder(widget.orderID, fromTracking: true)
          .whenComplete(() {
                  ...
                  orderProvider.trackModel != null
                      ? Column(children: [
                          ...
                          Row(
                              ...
                              children: [
                                Text('${getTranslated('your_order', context)}',
                                    style: rubikMedium),
                          ...
                          Column(children: [
                            ...
                            Consumer<LocationProvider>(
                              ...
                              if (locationProvider.addressList != null) {
                                for (int i = 0;
                                    i < locationProvider.addressList!.length;
                                    i++) {
                              ...
                              return CustomStepper(
                                ...
                                height: orderProvider.trackModel?.deliveryMan ==
                                        null
                                    ? 30
                                    : 130,
