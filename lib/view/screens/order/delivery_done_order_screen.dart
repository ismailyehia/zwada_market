...
import 'package:flutter_restaurant/view/screens/order/widget/accept_details_view.dart';
import 'package:flutter_restaurant/view/screens/order/widget/done_details_view.dart';
import 'package:provider/provider.dart';
import 'widget/button_view.dart';

class DeliveryDoneOrderScreen extends StatefulWidget {
  final OrderModel? orderModel;
  final int? orderId;
  final String? phoneNumber;
  const DeliveryDoneOrderScreen(
      {Key? key,
  ...
  @override
  State<DeliveryDoneOrderScreen> createState() =>
      _DeliveryDoneOrderScreenState();
}

class _DeliveryDoneOrderScreenState extends State<DeliveryDoneOrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: (ResponsiveHelper.isDesktop(context)
              ...
              : CustomAppBar(
                  context: context, title: getTranslated('delivered', context)))
