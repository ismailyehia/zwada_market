        ...
        child: Column(
          ...
          children: [
                                ...
                                order.trackModel!.orderStatus ==
                                    ...
                                    ? Provider.of<ProfileProvider>(Get.context!,listen: false)
                                        ...
                                        ? CustomButton(
                                            ...
                                            //   responseModel = await Provider.of<
                                            //               OrderProvider>(
                                            //           context,
                                            //           listen: false)
                                            //       .deliverOrderDelivery(order
                                            //           .trackModel!.id
                                            //           .toString());
                                    ...
                                    : CustomButton(
                                        ...
                                        onTap: () async {
                                          ...
                                          Provider.of<ProfileProvider>(
                                                  ...
                                                  'sales'
                                              ? RouterHelper
                                                  .getSalesAcceptOrderRoute(
                                                  order.trackModel!.id
                                                      .toString(),
                                                )
                                              // ignore: use_build_context_synchronously
                                              : responseModel = await Provider
                                                      .of<OrderProvider>(
                                                          context,
                                                          listen: false)
                                    ...
                                    children: [
                                      CustomButton(
                                        ...
                                        textStyle: const TextStyle(
                                            color: Colors.white),
                                        onTap: () {
                                          RouterHelper.getSalesRejectOrderRoute(
                                            order.trackModel!.id.toString(),
                                          );
                                        },
                                      ),
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double priceAfterDiscount =
                    price! - orderDetails.discountOnProduct!;
            ...
            (order.trackModel!.orderNote != null &&
                ...
                : const SizedBox(),
            (order.trackModel!.deliveryRejectReason != null &&
                    order.trackModel!.deliveryRejectReason!.isNotEmpty)
                ? Container(
                    padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                    margin: const EdgeInsets.only(
                        bottom: Dimensions.paddingSizeLarge),
                    ...
                    child: Text(order.trackModel!.deliveryRejectReason!,
                        style: rubikRegular.copyWith(
                            color:
                                Theme.of(context).hintColor.withOpacity(0.7))),
                  )
