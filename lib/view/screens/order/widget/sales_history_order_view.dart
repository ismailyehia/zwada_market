...
import 'package:flutter_restaurant/view/base/sales_history_order_widget.dart';
import 'package:flutter_restaurant/view/screens/home/web/widget/product_web_card_shimmer.dart';
import 'package:provider/provider.dart';

class SalesHistoryOrderView extends StatelessWidget {
  final bool isRunning;
  const SalesHistoryOrderView({Key? key, required this.isRunning}) : super(key: key);
        ...
        if(orderList.isEmpty) {
          ...
          return RefreshIndicator(
            ...
            GridView.builder(
              ...
              shrinkWrap: true,
              itemBuilder: (BuildContext context, int index) {
                return SalesHistoryOrderWidget(order: orderList![index]);
              },
            ),
