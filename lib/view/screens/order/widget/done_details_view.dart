...
class DoneDetailsView extends StatefulWidget {
  const DoneDetailsView({Key? key}) : super(key: key);

  @override
  _DoneDetailsViewState createState() => _DoneDetailsViewState();
}

class _DoneDetailsViewState extends State<DoneDetailsView> {
          ...
          children: [
            ...
            Row(
              children: [
                Radio(
                  value:
                      'cash', // Provide a unique value for the 'Store' option
                ...
                Text(
                  getTranslated('cash', context)!,
                  style: const TextStyle(fontSize: 16),
                ),
                const SizedBox(width: 16),
                Radio(
                  value:
                      'deferred_payment', // Provide a unique value for the 'Supplier' option
                  groupValue: _paymentMethod,
                  onChanged: (value) {
                    setState(() {
                      _paymentMethod = value as String;
                ...
                Text(
                  getTranslated('deferred_payment', context)!,
                  style: const TextStyle(fontSize: 16),
                ),
              ],
            ),
                          ...
                          Expanded(
                            child: Column(
                              children: [
                                CustomButton(
                                  isBorder: false,
                                  backgroundColor: const Color(0xFF43d97a),
                                  height: 45,
                                  btnTxt: getTranslated('delivered', context),
                                  textStyle:
