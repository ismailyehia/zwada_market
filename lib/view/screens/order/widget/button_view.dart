...
class ButtonView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isPhoneNotAvailable =
        (phoneNumber == null || (phoneNumber != null && phoneNumber!.isEmpty));
    final double width = MediaQuery.of(context).size.width;
    bool hasNonPendingStatus;

    return Consumer<OrderProvider>(builder: (context, order, _) {
      hasNonPendingStatus = order.trackModel!.details!.any((detail) {
          ...
          order.trackModel!.orderStatus == 'delivered' &&
              ...
              ? Center(
                  child: Container(
                    ...
                    //   onTap: () => RouterHelper.getRateReviewRoute(
