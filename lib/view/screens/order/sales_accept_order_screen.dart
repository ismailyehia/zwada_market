...
class SalesAcceptOrderScreen extends StatefulWidget {
  final OrderModel? orderModel;
  final int? orderId;
  final String? phoneNumber;
  const SalesAcceptOrderScreen(
      {Key? key,
  ...
  @override
  State<SalesAcceptOrderScreen> createState() => _SalesAcceptOrderScreenState();
}

class _SalesAcceptOrderScreenState extends State<SalesAcceptOrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: (ResponsiveHelper.isDesktop(context)
              ...
              : CustomAppBar(
                  context: context,
                  title: getTranslated('Accept Order', context)))
