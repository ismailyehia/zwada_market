...
class LocationProvider with ChangeNotifier {
  ...
  get $getGuestId => sharedPreferences?.getString(AppConstants.guestId);
  ...
  Future<ResponseModel?> initAddressList() async {
    ...
    String? usertId = sharedPreferences?.getString(AppConstants.userIdKey);
    print('user id for address: $usertId');

    ApiResponse apiResponse = await locationRepo!.getAllAddress(userId: usertId);
  ...
  Future<ResponseModel> addAddress(AddressModel addressModel , String guestId) async {
    _isLoading = true;
    notifyListeners();
