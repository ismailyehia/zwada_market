...
import 'package:flutter_restaurant/view/screens/category/brand_screen.dart';
import 'package:flutter_restaurant/view/screens/category/category_list_screen.dart';
...
import 'package:flutter_restaurant/view/screens/dashboard/delivery_dashboard_screen.dart';
import 'package:flutter_restaurant/view/screens/dashboard/sales_dashboard_screen.dart';
...
import 'package:flutter_restaurant/view/screens/gifts/gift_list_screen.dart';
...
import 'package:flutter_restaurant/view/screens/offer/offer_list_screen.dart';
import 'package:flutter_restaurant/view/screens/onSale/on_sale_list_screen.dart';
import 'package:flutter_restaurant/view/screens/onboarding/onboarding_screen.dart';
import 'package:flutter_restaurant/view/screens/order/customer_profile_screen.dart';
import 'package:flutter_restaurant/view/screens/order/delivery_done_order_screen.dart';
...
import 'package:flutter_restaurant/view/screens/order/sales_accept_order_screen.dart';
import 'package:flutter_restaurant/view/screens/order/sales_order_details_screen.dart';
import 'package:flutter_restaurant/view/screens/order/sales_reject_order_screen.dart';
import 'package:flutter_restaurant/view/screens/order/success_page_screen.dart';
...
import 'package:flutter_restaurant/view/screens/zone/zone_screen.dart';
...
class RouterHelper {
  ...
  static const String salesDashboardScreen = '/sales/main';
  static const String deliveryDashboardScreen = '/delivery/main';
  static const String searchScreen = '/search';
  static const String searchResultScreen = '/search-result';
  static const String setMenuScreen = '/set-menu';
  static const String categoryScreen = '/category';
  static const String brandScreen = '/brand';
  static const String categoryListScreen = '/categoryList';
  static const String offerListScreen = '/offerList';
  static const String onSaleListScreen = '/OnSaleList';
  static const String giftListScreen = '/GiftList';
  ...
  static const String zoneScreen = '/zones';
  static const String salesOrderDetailsScreen = '/sales-order-details';
  static const String successPageScreen = '/success-page-screen';
  static const String salesAcceptOrderScreen = '/sales-accept-order';
  static const String deliveryDoneOrderScreen = '/delivery-done-order';
  static const String salesRejectOrderScreen = '/sales-reject-order';
  ...
  static String getSalesMainRoute({RouteAction? action}) =>_navigateRoute(salesDashboard, route: action);
  static String getDeliveryMainRoute({RouteAction? action}) =>
      _navigateRoute(deliveryDashboard, route: action);
  ...
  static String getSalesDashboardRoute(String page, {RouteAction? action}) =>
      _navigateRoute('$salesDashboardScreen?page=$page', route: action);
  static String getDeliveryDashboardRoute(String page, {RouteAction? action}) =>
      _navigateRoute('$deliveryDashboardScreen?page=$page', route: action);
  ...
  static String getBrandRoute(BrandModel brandModel, {RouteAction? action}) {
    String imageUrl = base64Url.encode(utf8.encode(brandModel.image ?? ''));
    return _navigateRoute(
        '$brandScreen?id=${brandModel.id}&name=${brandModel.name}&img=$imageUrl',
        route: action);
  }

  static String getCategoryListRoute(String type, {RouteAction? action}) {
    return _navigateRoute('$categoryListScreen?type=$type', route: action);
  }

  static String getOfferListRoute({RouteAction? action}) {
    return _navigateRoute(offerListScreen, route: action);
  }

  static String getOnSaleListRoute(
      {RouteAction? action, String? isSale, String? supplierId}) {
    return _navigateRoute(
        '$onSaleListScreen?isSale=$isSale&supplierId=$supplierId',
        route: action);
  }

  static String getGiftListRoute({RouteAction? action}) {
    return _navigateRoute(giftListScreen, route: action);
  }
  ...
  static String getCheckoutRoute(double? amount, String page, String? type) {
    ...
    return _navigateRoute(
        '$checkoutScreen?amount=$amount0&page=$page&type=$type');
  }
  ...
  static String getZoneRoute() => _navigateRoute(zoneScreen);
  static String getOrderDetailsRoute(String? id) =>
      _navigateRoute('$orderDetailsScreen?id=$id');
  static String getSalesOrderDetailsRoute(String? id) =>_navigateRoute('$salesOrderDetailsScreen?id=$id');
  static String getSuccessPageRoute(String? title, String? subtitle) =>
      _navigateRoute('$successPageScreen?title=$title&subtitle=$subtitle');
  static String getSalesAcceptOrderRoute(String? id) =>
      _navigateRoute('$salesAcceptOrderScreen?id=$id');
  static String getDeliveryDoneOrderRoute(String? id) =>
      _navigateRoute('$deliveryDoneOrderScreen?id=$id');
  static String getSalesRejectOrderRoute(String? id) =>
      _navigateRoute('$salesRejectOrderScreen?id=$id');
  static String getCustomerProfileRoute(String? id) =>
      _navigateRoute('$customerProfileScreen?id=$id');
  ...
  static final goRoutes = GoRouter(
    ...
    routes: [
                  ...
                  pageIndex: state.uri.queryParameters['page'] == 'home'
                      ...
                      : state.uri.queryParameters['page'] == 'cart'
                          ...
                          : state.uri.queryParameters['page'] == 'order'
                              ? 2
                              : state.uri.queryParameters['page'] == 'messages'
                                  ? 3
          ...
          builder: (context, state) {
            return _routeHandler(
                ...
                SalesDashboardScreen(
                  pageIndex: state.uri.queryParameters['page'] == 'home'
                      ? 0
                      : state.uri.queryParameters['page'] == 'history'
                          ? 1
                          : state.uri.queryParameters['page'] == 'messages'
                              ? 2
                              : state.uri.queryParameters['page'] == 'menu'
      ...
      GoRoute(
          path: salesDashboard,
          builder: (context, state) =>
              _routeHandler(context, const SalesDashboardScreen(pageIndex: 0))),
      GoRoute(
          path: deliveryDashboard,
          builder: (context, state) => _routeHandler(
              context, const DeliveryDashboardScreen(pageIndex: 0))),
      GoRoute(
          path: searchScreen,
          builder: (context, state) =>
      ...
      GoRoute(
          ...
          builder: (context, state) {
            ...
            return _routeHandler(
                context,
                BrandScreen(
                  brandId: state.uri.queryParameters['id']!,
                  brandName: state.uri.queryParameters['name'],
                  brandBannerImage: image,
                ),
                isBranchCheck: true);
          }),
      GoRoute(
      ...
      GoRoute(
          path: offerListScreen,
          builder: (context, state) {
            return _routeHandler(context, const OfferListScreen());
          }),
      GoRoute(
          path: onSaleListScreen,
          builder: (context, state) {
            bool isSale = state.uri.queryParameters['isSale'] == 'true' ||
                state.uri.queryParameters['isSale'] == null;
            String? supplierId = state.uri.queryParameters['supplierId'];
            return _routeHandler(
                context,
                OnSaleListScreen(
                  isSale: isSale,
      ...
      GoRoute(
          path: giftListScreen,
          builder: (context, state) {
            return _routeHandler(context, const GiftListScreen());
          }),
      GoRoute(
      ...
      GoRoute(
          path: zoneScreen,
          builder: (context, state) =>
              _routeHandler(context, const ZoneScreen())),
      GoRoute(
          path: salesOrderDetailsScreen,
          builder: (context, state) => _routeHandler(
              context,
      ...
      GoRoute(
          path: salesAcceptOrderScreen,
          builder: (context, state) => _routeHandler(
              context,
              SalesAcceptOrderScreen(
                orderId: int.parse(state.uri.queryParameters['id'] ?? ''),
                orderModel: null,
              ))),
      GoRoute(
          path: deliveryDoneOrderScreen,
          builder: (context, state) => _routeHandler(
              context,
              DeliveryDoneOrderScreen(
                orderId: int.parse(state.uri.queryParameters['id'] ?? ''),
                orderModel: null,
              ))),
      GoRoute(
          path: salesRejectOrderScreen,
          builder: (context, state) => _routeHandler(
              context,
              SalesRejectOrderScreen(
                orderId: int.parse(state.uri.queryParameters['id'] ?? ''),
                orderModel: null,
              ))),
      GoRoute(
          ...
          builder: (context, state) => _routeHandler(
              ...
              CustomerProfileScreen(
                customerId: int.parse(state.uri.queryParameters['id'] ?? ''),
                customerModel: null,
              ))),
      GoRoute(
          path: rateScreen,
